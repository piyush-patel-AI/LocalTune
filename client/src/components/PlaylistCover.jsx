...
export default function PlaylistCover({ playlist, tracks = [], size = 48, className = '' }) {
  ...
  if (playlist.cover_path) {
    return (
      <div
        ...
        style={{ width: `${size}px`, height: `${size}px`, borderRadius: '8px', overflow: 'hidden', flexShrink: 0, position: 'relative' }}
      >
        <img
  ...
  if (artworkTracks.length >= 4) {
    return (
      <div
        ...
        style={{ width: `${size}px`, height: `${size}px`, flexShrink: 0, borderRadius: '8px', overflow: 'hidden' }}
      >
  ...
  if (artworkTracks.length > 0) {
    return (
      <div
        className={`playlist-cover-wrapper ${className}`}
        style={{ width: `${size}px`, height: `${size}px`, borderRadius: '8px', overflow: 'hidden', flexShrink: 0 }}
      >
        <img
